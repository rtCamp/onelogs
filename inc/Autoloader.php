...
final class Autoloader {
	...
	public static function autoload(): bool {
		...
		if ( defined( 'ONELOGS_AUTOLOAD' ) && false === ONELOGS_AUTOLOAD ) {
			return true;
		}
		...
		foreach ( $hooks as $hook ) {
			add_action(
				...
				static function (): void {
					$error_message = __( 'OneLogs: The Composer autoloader was not found. If you installed the plugin from the GitHub source code, make sure to run `composer install`.', 'onelogs' );
